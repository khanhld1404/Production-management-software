...
{
    public partial class UC_Status_TwoCategory : UserControl
    {
        ...
        public UC_Status_TwoCategory(string _type)
        {
            InitializeComponent();
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                using (Entities db = new Entities(clConnection.connectEntity))
                {
                    ...
                    int chuaDG = (qr_total_next > 0 ? qr_complete_next : qr_complete) - Convert.ToInt32(lbDGTotal.Text);
