...
namespace EVS_Management
{
    public static class clConnection
    {
        ...
        public static string connectString = @"Data Source=10.239.1.162;Initial Catalog=EVS_Management;Persist Security Info=True;User ID=khanh_ld;Password=250711;Encrypt=False;";
